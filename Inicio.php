...
<body>
    ...
    <header id="header">
        ...
        <div id="top-nav">
            <div class="container">
                ...
                <!-- logo -->
                <div class="logo">
                    <a href="Inicio.html"><img src="/WebStyles2/img/logo.png" alt="logo"></a>
                </div>
                <!-- logo -->
                <!-- Mobile toggle -->
    ...
    <div id="home" class="banner-area">
        ...
        <!-- Backgound Image -->
        <div class="bg-image bg-parallax overlay" style="background-image: url('../../webstyles2/img/background01.jpg');"></div>
        <!-- /Backgound Image -->
        ...
        <div class="home-wrapper">
            ...
            <div class="col-md-10 col-md-offset-1 text-center">
                <div class="home-content">
                    <h1 class="white-text">Welcome To Cafeteria Web Restaurant</h1>
                    ...
                    <a  id="AboutUs"   href="index.html#menu"><button class="main-button">Discover Menu</button></a>
                </div>
            </div>
                    ...
                    <div id="Gallery" class="owl-carousel owl-theme">
                        ...
                        <div class="Gallery-item">
                            ...
                            <div class="item-column">
                                <!-- single image -->
                                <div class="Gallery-img" style="background-image: url('../../webstyles2/img/image04.jpg');"></div>
                                <!-- /single image -->
                                <!-- single image -->
                                <div class="Gallery-img" style="background-image: url('../../webstyles2/img/image05.jpg');"></div>
                                <!-- /single image -->
                            </div>

                            <div class="item-column">
                                <!-- single image -->
                                <div class="Gallery-img" style="background-image: url('../../webstyles2/img/image06.jpg');"></div>
                                <!-- /single image -->
                                <!-- single image -->
                                <div class="Gallery-img" style="background-image: url('../../webstyles2/img/image07.jpg');"></div>
                                <!-- /single image -->
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="section-header text-center">
                    ...
                    <h2  id="OurMenu"   class="title white-text">Our Menu</h2>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-1 col-sm-10 col-sm-offset-1">
                    <form class="reserve-form row">
                        <div class="section-header text-center">
                            <h4 id="Reservation"   class="sub-title">Reservation</h4>
    ...
    <div id="events" class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- section header -->
                <div class="section-header text-center">
                    <h4  id="Gallery"    class="sub-title">Special Event</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-7">
                    <div class="section-header">
                        <h4   id="ContactUs"   class="sub-title">Contact Us</h4>
